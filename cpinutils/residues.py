...
refene2.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene2.dielc2.solvent_energies()
refene3 = _ReferenceEnergy(igb2=0, igb5=0)
refene3.solvent_energies()
refene3.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene3.dielc2.solvent_energies()
refene4 = _ReferenceEnergy(igb2=0, igb5=0)
refene4.solvent_energies()
refene4.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene4.dielc2.solvent_energies()
refene5 = _ReferenceEnergy(igb2=0, igb5=0)
refene5.solvent_energies()
refene5.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene5.dielc2.solvent_energies()
refene6 = _ReferenceEnergy(igb2=0, igb5=0)
refene6.solvent_energies()
refene6.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene6.dielc2.solvent_energies()
refene7 = _ReferenceEnergy(igb2=0, igb5=0)
refene7.solvent_energies()
refene7.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene7.dielc2.solvent_energies()
refene8 = _ReferenceEnergy(igb2=0, igb5=0)
refene8.solvent_energies()
refene8.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene8.dielc2.solvent_energies()
refene9 = _ReferenceEnergy(igb2=0, igb5=0)
refene9.solvent_energies()
refene9.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene9.dielc2.solvent_energies()
refene10 = _ReferenceEnergy(igb2=0, igb5=0)
refene10.solvent_energies()
refene10.dielc2_energies(igb2=0, igb5=0, igb8=0)
refene10.dielc2.solvent_energies()


pxyl = TitratableResidue('pxyl', ['C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'H7', 'H8', 'H9', 'H10'], pka=7.0)
pxyl.add_state(protcnt=1, refene=refene1, charges=[0.12488999962806702, -0.1653899997472763, -0.10570000112056732, -0.1418199986219406, -0.1123099997639656, -0.055810000747442245, -0.05313999950885773, -0.055730000138282776, -0.1423500031232834, 0.14656999707221985, 0.13580000400543213, 0.13530999422073364, 0.04941000044345856, 0.04941000044345856, 0.04941000044345856, 0.04715000092983246, 0.04715000092983246, 0.04715000092983246])
pxyl.add_state(protcnt=1, refene=refene2, charges=[-0.1652500033378601, 0.12470000237226486, -0.14172999560832977, -0.10523000359535217, -0.05665000155568123, -0.11223000288009644, -0.05561999976634979, -0.053630001842975616, 0.14616000652313232, -0.14215999841690063, 0.13568000495433807, 0.13589000701904297, 0.04707000032067299, 0.04707000032067299, 0.04707000032067299, 0.049619998782873154, 0.049619998782873154, 0.049619998782873154])
pxyl.add_state(protcnt=1, refene=refene3, charges=[-0.10576999932527542, -0.14281000196933746, 0.12451999634504318, -0.1645199954509735, -0.11229000240564346, -0.05550999939441681, -0.05259000137448311, -0.055560000240802765, 0.1363299936056137, 0.13429999351501465, -0.1436299979686737, 0.14715999364852905, 0.04966999962925911, 0.04966999962925911, 0.04966999962925911, 0.047120001167058945, 0.047120001167058945, 0.047120001167058945])
pxyl.add_state(protcnt=1, refene=refene4, charges=[-0.1425900012254715, -0.10582000017166138, -0.1646600067615509, 0.12482000142335892, -0.056129999458789825, -0.11208000034093857, -0.05553000047802925, -0.052639998495578766, 0.13422000408172607, 0.13636000454425812, 0.14696000516414642, -0.14337000250816345, 0.047200001776218414, 0.047200001776218414, 0.047200001776218414, 0.049619998782873154, 0.049619998782873154, 0.049619998782873154])
